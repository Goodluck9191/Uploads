				...
				<div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3  gap-x-2 gap-y-5 py-10 px-10">
					<div className="bg-cyan-400 shadow-2xl px-4 py-5 w-87.5 rounded-2xl flex flex-col justify-center ">
						...
						<div className="flex  justify-between">
							...
							<p className="text-sm">Goodluck</p>
						</div>
				
						
						<div className="flex justify-between py-5 ">
							<button className="bg-accent px-3 py-3 rounded-lg hover:cursor-pointer">view Details</button>
							<button className="bg-white px-3 py-3 rounded-lg hover:cursor-pointer">Edit</button>
							<button className="bg-red-400 px-3 py-3 rounded-xl hover:cursor-pointer">view Details</button>
							
						</div>
						
					</div>
					<div className="bg-cyan-400 shadow-2xl px-4 py-5 w-[350px] rounded-2xl flex flex-col justify-center ">
						<div className="flex  justify-between">
							<h1 className="text-primary">Table</h1>
							<p className="text-secondary">In use</p>
